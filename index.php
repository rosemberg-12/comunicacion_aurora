...
if( ( isset($_POST['documento']) && isset($_POST['password']) ) )
{
    ...
    $var=$facade->iniciarSesionCliente($_POST['documento'],$_POST['password']);
            ...
            <div class="content-wrapper inicio">
                ...
                <section class="content">
                    <!-- Incluir aqui el contenido-->
                        <div class="login-box">
                              <div class="login-logo" style="background-color: #fff; color: #fff; border-style: solid; border-width: 1px; border-color: black">
                                        ...
                                        <p class="login-box-msg">Logueate para iniciar sesión</p>
                                                ...
                                                <div id="tok">
                                                  ...
                                                  <div class="form-group has-feedback">
                                                    <input type="text" class="form-control" placeholder="Codigo de ingreso" name="documento" id="documento" required="" title="Número de Documento">
