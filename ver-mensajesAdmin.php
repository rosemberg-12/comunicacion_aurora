        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" >
                ...
                <section class="content">
                        ...
                        <div class="modal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header" style="background:#B7B7B7">
                                        <button type="button"  class="close">
                                            <span>Nuevo Mensaje</span></button>

                                        <h4 class="modal-title">Emisor: Administrador</h4>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="registrarMensajeAdmin.php" method="post" id="registrarMensaje">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-4">
                                                    ...
                                                    <input type="hidden" id="nombre" name="nombre" value="<?php echo $_GET['nombre'];?>" >
                    ...
                    <?php echo $facade->cargarMensajesAdmin($_GET['id_novedad'], $nombre); ?>
